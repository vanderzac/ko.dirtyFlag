...
* License: MIT (http://www.opensource.org/licenses/mit-license.php)*/
    ...
    (function () {
        ...
        // Hooks are marked with /*** Custom Hook ***/

        // I have added a hook in the function getPathSettingsDictionary(options): applyExtendedSettings(options)

        // I have added hooks within the function recrusiveFrom(modelObj, settings, context, pathSettings)
        // hooks are at the start and end of each flow control block used to switch between observable/array/object

        function applyExtendedSettings(settings) {
            settings = settings || {};

            makeObservable = settings.makeObservable || makeObservable;
            beforeProcessObservable = settings.beforeProcessObservable || function (toMap) { };
            afterProcessObservable = settings.afterProcessObservable || function (result) { };

            makeObservableArray = settings.makeObservableArray || makeObservableArray;
            beforeProcessObservableArray = settings.beforeProcessObservableArray || function (toMap) { };
            afterProcessObservableArray = settings.afterProcessObservableArray || function (result) { };

            beforeProcessObject = settings.beforeProcessObject || function (toMap) { };
            afterProcessObject = settings.afterProcessObject || function (result) { };

            unwrap = settings.unwrap || function (toUnwrap) { throw new Error('unwrap not defined'); };
        }
        ...
        function recrusiveFrom(modelObj, settings, context, pathSettings) {
            ...
            if (customPathSettings = pathSettings.custom) {
                ...
                /*** Custom Hook ***/
                beforeProcessObservable(modelObj);
                /*** Custom Hook ***/
                ...
                /*** Custom Hook ***/
                afterProcessObservable(result);
                /*** Custom Hook ***/
            }
            else if (modelObj instanceof Array) {

                /*** Custom Hook ***/
                beforeProcessObservableArray(modelObj);
                /*** Custom Hook ***/
                ...
                /*** Custom Hook ***/
                afterProcessObservableArray(result);
                /*** Custom Hook ***/
            }
            else if (modelObj.constructor === Object) {

                /*** Custom Hook ***/
                beforeProcessObject(modelObj);
                /*** Custom Hook ***/
